...
url="https://api.meetup.com/2/groups?&sign=true&photo-host=public&category_id=34&country=IN&city=Pune&only=name,id,created,topics&key=3c2f404715287713157b6b747e507969"
  ...
  for i in data :
    ...
    for j in temp:
        ...
        if t in count:
          ...
          if s < 1325376000:      #2011
            count[t][1] = count[t][1]+1

          if s < 1356998400:      #2012
            count[t][2] = count[t][2]+1

          if s < 1388534400:      #2013
            count[t][3] = count[t][3]+1

          if s < 1420070400:      #2014
            count[t][4] = count[t][4]+1

          if s < 1451606400:      #2015
            count[t][5] = count[t][5]+1

          count[t][6] = count[t][6]+1   #2016
...
with open('folder1/Pune.csv', 'w') as myfile:
