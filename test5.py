...
for index in range(len(name)):
    ...
    score.append({'id':grp_id[index] , 'name':str(name[index]),'description':info[grp_id[index]][5],'score':10*stats.norm.cdf(0.2 * members_zscore[index] + 0.2 * rating_zscore[index] + 0.2 * act_members_zscore[index] + 0.2 * freq_zscore[index] + 0.2 * leads_zscore[index])})
   # score[grp_id[index]] = [name[index],10*stats.norm.cdf(0.2 * members_zscore[index] + 0.2 * rating_zscore[index] + 0.2 * act_members_zscore[index] + 0.2 * freq_zscore[index] + 0.2 * leads_zscore[index])]
# print score
